  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="x_panel">
      ...
      <div class="x_title">
        ...
        <h2>{{trans('degree.Edit_Degree')}}</h2>
      ...
      <div class="x_content">
        ...
        <form method="post" action="{{action('DegreeController@update', $id)}}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                  {{csrf_field()}}
          ...
          <div class="form-group{{ $errors->has(trans('variable.Name_En')) ? ' has-error' : '' }}">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" id="{{trans('variable.Name_En')}}" name="{{trans('variable.Name_En')}}" class="form-control col-md-7 col-xs-12" placeholder="{{trans('degree.Degree_English')}}" value="{{$degree->$Name_En}}">
            </div>
          </div>
          ...
          <div class="form-group{{ $errors->has(trans('variable.Name_Ar')) ? ' has-error' : '' }}">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" id="{{trans('variable.Name_Ar')}}" name="{{trans('variable.Name_Ar')}}" class="form-control col-md-7 col-xs-12" placeholder="{{trans('degree.Degree_Arabic')}}" value="{{ $degree->$Name_Ar }}">
            </div>
          </div>
