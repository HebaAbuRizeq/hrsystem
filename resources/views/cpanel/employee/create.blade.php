...
<div class="row">
  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        <!-- Form -->
        <form method="POST" action="{{url('cpanel/employee')}}" id="demo-form2" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
          {{csrf_field()}}
          <!-- Administration -->
  ...
  <div class="row">
          ...
          <div class="col-md-3 col-sm-12 col-xs-12 form-group{{ $errors->has('sn') ? ' has-error' : '' }} ">
            <input type="text"  name="sn" class="form-control" placeholder="{{trans('employee.sn')}}" value="{{ old('sn') }}">
          ...
          <div class="col-md-3 col-sm-12 col-xs-12 form-group{{ $errors->has('emp_no') ? ' has-error' : '' }}">
            <input type="text"  name="emp_no" class="form-control" placeholder="{{trans('employee.emp_no')}}" value="{{ old('emp_no') }}">
          </div>
          <label class="col-md-2 required" style="width:2%;"><span class="required">*</span></label>
          <div class="col-md-3 col-sm-12 col-xs-12 form-group{{ $errors->has('username') ? ' has-error' : '' }}">
            <input type="text"  name="username" class="form-control" placeholder="{{trans('employee.username')}}" value="{{ old('username') }}">
          </div>
        </div>
        <!-- /ID Number,Functional Number,User Name -->
        <!-- Mobile,Ext,Email  -->
        ...
        <div class="col-md-3 col-sm-12 col-xs-12 form-group{{ $errors->has('mobile') ? ' has-error' : '' }}">
          <input type="text"  name="mobile" class="form-control" placeholder="{{trans('cpanel.Mobile')}}" value="{{ old('mobile') }}">
        </div>
        ...
        <div class="col-md-3 col-sm-12 col-xs-12 form-group{{ $errors->has('ext') ? ' has-error' : '' }}">
          <input type="text" name="ext" class="form-control" placeholder="{{trans('employee.Ext')}}" value="{{ old('ext') }}">
        </div>

        <label class="col-md-2 required" style="width:2%;"></label>
        <div class=" col-md-3 col-sm-12 col-xs-12 form-group{{ $errors->has('email') ? ' has-error' : '' }}">
          <input type="text" name="email" class="form-control" placeholder="{{trans('cpanel.Email')}}" value="{{ old('email') }}">
      ...
      <!-- /Mobile,Ext,Email  -->
          ...
          <div class="col-md-2 col-sm-12 col-xs-12 form-group{{ $errors->has('firstname_ar') ? ' has-error' : '' }} ">
            <input type="text" name="firstname_ar" class="form-control" placeholder="{{trans('employee.firstname_ar')}}" value="{{ old('firstname_ar') }}">

          </div>
          <label class="col-md-2 required" style="width:2%;"><span class="required">*</span></label>
          <div class="col-md-2 col-sm-12 col-xs-12 form-group{{ $errors->has('secondname_ar') ? ' has-error' : '' }}">
            <input type="text" name="secondname_ar" class="form-control" placeholder="{{trans('employee.secondname_ar')}}" value="{{ old('secondname_ar') }}">

          </div>
          <label class="col-md-2 required" style="width:2%;"><span class="required">*</span></label>
          <div class="col-md-2 col-sm-12 col-xs-12 form-group{{ $errors->has('thirdname_ar') ? ' has-error' : '' }}">
            <input type="text" name="thirdname_ar" class="form-control" placeholder="{{trans('employee.thirdname_ar')}}" value="{{ old('thirdname_ar') }}">

          </div>
          <label class="col-md-2 required" style="width:2%;"><span class="required">*</span></label>
          <div class="col-md-2 col-sm-12 col-xs-12 form-group{{ $errors->has('lastname_ar') ? ' has-error' : '' }}">
            <input type="text" name="lastname_ar" class="form-control" placeholder="{{trans('employee.lastname_ar')}}" value="{{ old('lastname_ar') }}">
        ...
        <div class="col-md-2 col-sm-12 col-xs-12 form-group{{ $errors->has('firstname_en') ? ' has-error' : '' }} ">
          <input type="text" name="firstname_en" placeholder="{{trans('employee.firstname_en')}}" value="{{ old('firstname_en') }}" class="form-control">
        </div>
        <label class="col-md-2 required" style="width:2%;"><span class="required"></span></label>
        <div class="col-md-2 col-sm-12 col-xs-12 form-group{{ $errors->has('secondname_en') ? ' has-error' : '' }}">
          <input type="text"  name="secondname_en" placeholder="{{trans('employee.secondname_en')}}" value="{{ old('secondname_en') }}" class="form-control">
        </div>
        <label class="col-md-2 required" style="width:2%;"><span class="required"></span></label>
        <div class="col-md-2 col-sm-12 col-xs-12 form-group{{ $errors->has('thirdname_en') ? ' has-error' : '' }}">
          <input type="text" name="thirdname_en"  placeholder="{{trans('employee.thirdname_en')}}" value="{{ old('thirdname_en') }}" class="form-control">
        </div>
        <label class="col-md-2 required" style="width:2%;"><span class="required"></span></label>
        <div class="col-md-2 col-sm-12 col-xs-12 form-group{{ $errors->has('lastname_en') ? ' has-error' : '' }}">
          <input type="text" name="lastname_en" placeholder="{{trans('employee.lastname_en')}}" value="{{ old('lastname_en') }}" class="form-control">
        </div>
      </div>
      <!-- /Full name English -->
    <!-- Job Recruitmen -->
  ...
  <!-- /Job Recruitmen -->
      ...
      <div class="col-md-2 col-sm-12 col-xs-12 form-group{{ $errors->has('yearofdegree') ? ' has-error' : '' }}">
        <input type="text" name="yearofdegree" placeholder="{{trans('employee.yearofdegree')}}" class="form-control">
       </div>
    </div>
    <!-- /Recruitmen,Category,Degree,yearofdegree -->
  ...
  <div class="col-md-2 col-sm-12 col-xs-12 form-group{{ $errors->has('dateofbirth') ? ' has-error' : '' }}">
                  ...
                  <input type="date" name="dateofbirth" id="dateofbirth" placeholder="dateofbirth" value="{{ old('dateofbirth') }}" class="form-control">
...
<div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="{{trans('cpanel.Assistant')}}">  {{trans('employee.dateofhiring')}}</label>
                                                  ...
                                                  <div class="col-md-2 col-sm-12 col-xs-12 form-group{{ $errors->has('dateofhiring') ? ' has-error' : '' }}">
                                                      <input type="date" name="dateofhiring" id="dateofhiring" placeholder="dateofbirth" value="{{ old('dateofhiring') }}" class="form-control">
...
<!-- /Photo-->
    ...
    var token = $("input[name='_token']").val();
    $.ajax({
    url: "<?php echo route('select-ajax-region') ?>",
    method: 'POST',
    data: {assistant_id:assistant_id, _token:token},
    success: function(data) {
  ...
  var token = $("input[name='_token']").val();
  $.ajax({
  url: "<?php echo route('select-ajax-instite') ?>",
  method: 'POST',
  data: {region_id:region_id, _token:token},
  success: function(data) {
  $("select[name='institute_id'").html('');
  $("select[name='institute_id'").html(data.options);
  }
  });
  });
  </script>
