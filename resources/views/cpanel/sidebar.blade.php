<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
  <div class="menu_section">
    ...
    <ul class="nav side-menu">
      ...
      <li><a><i class="fa fa-bar-chart-o"></i>  {{trans('cpanel.Report')}}<span class="fa fa-chevron-down"></span></a>
        <ul class="nav child_menu">
          <li><a href="{{ url('home/report') }}">{{trans('cpanel.QulJobReport')}}</a></li>
          <li><a href="{{ url('home/report2') }}">{{trans('cpanel.QualificationReport')}}</a></li>
          <li><a href="{{ url('home/report3') }}">{{trans('cpanel.JobReport')}}</a></li>
          <li><a href="{{ url('home/report4') }}">{{trans('cpanel.GenderReport')}}</a></li>
          <li><a href="{{ url('home/report5') }}">{{trans('cpanel.AgeReport')}}</a></li>
