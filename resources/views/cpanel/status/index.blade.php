...
<div class="row">
  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <button onclick="location.href='{{ url('cpanel/status/create') }}'" class="btn btn-dark" type="button">{{trans('status.Add_Status')}}</button>
    </div>
      ...
      <div class="x_content">
        ...
        <table id="example" class="display jambo_table">
          ...
          <tr>
            ...
            <td><a href="{{action('StatusController@edit', $status['id'])}}" data-toggle="tooltip"  title="Edit" ><i alt="Edit">{{trans('cpanel.Edit')}}</i></a> /
                <a href="{{ url('cpanel/status/delete',  $status['id']) }}" data-toggle="tooltip"  title="Delete" onclick="return confirm('{{trans('cpanel.Sure')}}')"><i alt="Delete">{{trans('cpanel.Delete')}}</i></a></td>
            </td>
          </tr>
        @endforeach
