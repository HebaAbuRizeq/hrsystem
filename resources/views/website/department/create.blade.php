  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="x_panel">
      ...
      <div class="x_title">
        ...
        <h2>{{trans('department.Add_New_Department')}}</h2>
      ...
      <div class="x_content">
        ...
        <form method="POST" action="{{route('department.store')}}" name="frm" id="frm" data-parsley-validate class="form-horizontal form-label-left">
       ...
       <div class="col-md-6 col-sm-6 col-xs-12">
         <select class="form-control" name="directorate_id">
          ...
          <div class="form-group{{ $errors->has(trans('variable.Name_En')) ? ' has-error' : '' }}">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" id="{{trans('variable.Name_En')}}" name="{{trans('variable.Name_En')}}" class="form-control col-md-7 col-xs-12" placeholder="{{trans('department.Department_English')}}" value="{{ old(trans('department.Name_En')) }}">
            </div>
          </div>
          ...
          <div class="form-group{{ $errors->has(trans('variable.Name_Ar')) ? ' has-error' : '' }}">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" id="{{trans('variable.Name_Ar')}}" name="{{trans('variable.Name_Ar')}}" class="form-control col-md-7 col-xs-12" placeholder="{{trans('department.Department_Arabic')}}" value="{{ old(trans('department.Name_Ar')) }}">
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
              ...
              <button type="submit" name="submit" id="submit" class="btn btn-success">{{trans('cpanel.Submit')}}</button>
            </div>
          </div>
